...
const Header = () => {
    ...
    return (
        <nav>
            <img src={menu} alt="menu" className="menu" onClick={() => setToggleMobileMenu(!toggleMobileMenu)} /> {/*Este es el ícono para mobile version - reto 5 / al presionar, muestre el menu de mobile*/}
